...
const ProductDetail = () => {
  ...
  return (
    <div className="flex-1 max-w-5xl mx-auto px-4 py-12 w-full">
      <Link to="/" className="text-secondary font-medium hover:text-secondary/80 mb-6 inline-block transition">&larr; Back to Products</Link>
      <div className="bg-surface rounded-2xl shadow-xl border border-neutral overflow-hidden">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="p-8 md:w-1/2 flex flex-col justify-center">
            ...
            <p className="text-secondary text-3xl font-bold mt-3">${product.price}</p>
